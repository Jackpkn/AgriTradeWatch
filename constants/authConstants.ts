...
// Location Options for Registration
export const LOCATION_OPTIONS = [
  { id: "auto", name: "Auto-detect Current", icon: "📍", description: "Use your current location" },
  { id: "map", name: "Choose from Map", icon: "🗺️", description: "Select location manually" },
];

// Language Options (for future use)
